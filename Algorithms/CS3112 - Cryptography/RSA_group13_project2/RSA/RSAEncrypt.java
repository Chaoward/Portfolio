...
public class RSAEncrypt {
	public static void encryptFile(String msgFilePath, String keyFilePath) {
    ...
    {	 if (args.length < 2)
    	{
            System.out.println("Usage: java RSAEncrypt1 <message_file> <public_key_file>");
            return;
		}
        ...
        try {
            ...
            E = new BigInteger(pub_e);
            N = new BigInteger(pub_n);
